/*-------------------------------------------------------------------------
 * $Id: p33FJ256MC710.h,v 1.1.2.10 2006/06/27 23:43:37 mccartg Exp $
 * MPLAB-Cxx  PIC33FJ256MC710 processor header
 *
...
extern volatile struct {
  ...
  unsigned PMOD3:1;
  unsigned PMOD4:1;
} PWMCON1bits __attribute__((__sfr__));
...
} PWMCON2bits __attribute__((__sfr__));
...
} DTCON1bits __attribute__((__sfr__));
...
extern volatile struct {
  ...
  unsigned DTS4I:1;
  unsigned DTS4A:1;
} DTCON2bits __attribute__((__sfr__));
...
extern volatile struct {
  ...
  unsigned FAOV4L:1;
  unsigned FAOV4H:1;
} FLTACONbits __attribute__((__sfr__));
...
extern volatile struct {
  ...
  unsigned FBOV4L:1;
  unsigned FBOV4H:1;
} FLTBCONbits __attribute__((__sfr__));
...
extern volatile struct {
  ...
  unsigned POVD4L:1;
  unsigned POVD4H:1;
} OVDCONbits __attribute__((__sfr__));
...
} QEICONbits __attribute__((__sfr__));
...
} DFLTCONbits __attribute__((__sfr__));
...
#define _PTMOD1 PTCONbits.PTMOD1
